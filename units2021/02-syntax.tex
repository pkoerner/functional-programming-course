...
\begin{itemize}
    ...
    \item Please be aware of \url{https://clojure.org/api/cheatsheet} and that there are many useful functions.
        Especially the blocks \enquote{Sequences}, \enquote{Primitives} and \enquote{Collections} are worth knowing.
...
\paragraph{Timeline:} This unit should be completed by 25.10.2021.
...
It is only important that the result is a sequential collection. The specific data structure is irrelevant (in particular: vectors are fine, returning nil rather than an empty collection is fine, too. This applies for all exercises, unless stated otherwise.).
\end{exercise}
